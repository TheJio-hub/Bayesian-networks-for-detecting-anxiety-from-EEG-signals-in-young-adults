...
def entrenar_y_evaluar(X, y, grupos, modelo):
    ...
    for indice_entrenamiento, indice_prueba in tqdm(validacion.split(X, y, grupos), total=total_folds, desc='LOGO RF', unit='fold', leave=False):
...
def principal():
    ...
    for n_caracteristicas, nombre_carpeta in tqdm(top_configuraciones, desc='Top configuraciones RF', unit='top'):
