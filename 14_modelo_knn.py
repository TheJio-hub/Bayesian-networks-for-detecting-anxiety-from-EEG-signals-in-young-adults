...
DIRECTORIO_SALIDA = os.path.join('Resultados', 'Modelos', 'KNN')
...
def main():
    ...
    # KNN requiere escalado de características (distancia euclidiana)
    ...
    print(f"\nEntrenando KNN (k=5) con validación LOGO...")
    ...
    print("\n" + "="*40)
    print(f"RESULTADOS KNN (Top {TOP_K_CARACTERISTICAS} Características)")
    print("="*40)
    ...
    plt.title(f'Matriz de Confusión KNN (Top {TOP_K_CARACTERISTICAS} mRMR)\nExactitud: {exactitud:.2f}')
    plt.ylabel('Verdadero')
    plt.xlabel('Predicho')
    plt.tight_layout()
    plt.savefig(os.path.join(DIRECTORIO_SALIDA, 'Matriz_Confusion_KNN.png'))
